...
import { faTruck, faEnvelope, faUmbrella, faCake} from '@fortawesome/free-solid-svg-icons'
        ...
        <div className="content-services">
            <div className="content-services-grid">
                <div className="content-services-items">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed delectus officiis obcaecati laboriosam? Qui, totam!</p>
                </div>
